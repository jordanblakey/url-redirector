...
test.describe('Content Script', () => {
  ...
  test('should remove url_redirector param and send message if present', async ({
    page,
    httpServer,
  }) => {
  ...
  test('should not modify URL or send message if url_redirector param is not present', async ({
    page,
    httpServer,
  }) => {
