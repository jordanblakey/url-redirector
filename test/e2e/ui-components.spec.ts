...
test.describe("UI Components", () => {
  ...
  test.describe("Placeholder Buttons", () => {
    test("should copy placeholder text to input and show visual feedback", async ({
      page,
    }) => {
